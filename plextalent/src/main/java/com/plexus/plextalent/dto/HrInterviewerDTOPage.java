...
@Data
@NoArgsConstructor
public class HrInterviewerDTOPage {
	private Pageable pageable;
	private List<HrInterviewerDTO> interviewerList;
	...
	/**
	 * Constructor that creates a new instance of HrInterviewerDTO with the provided
	 * pageable and HR interviewer list
	 * 
	 * @param pageable        The Pageable object containing the pagination
	 *                        parameters for the HR interviewer list
	 * @param interviewerList The list of HrInterviewer objects retrieved from the
	 *                        database
	 */

	public HrInterviewerDTOPage(Pageable pageable, List<HrInterviewerDTO> interviewerList) {
